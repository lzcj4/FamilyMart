...
namespace FamilyMartUI.ViewModel
{
    ...
    //    private ObservableCollection<DialyReport> items = null;
    //    protected ObservableCollection<DialyReport> Items { get { return items; } }

    //    #endregion

    //    public SearchViewModel()
    //    {
    //        items = new ObservableCollection<DialyReport>();
    ...
    //    protected bool AddItemsByChunk(IEnumerable<T> source, IList destination)
    //    {
